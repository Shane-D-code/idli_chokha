  ...
  return (
    <div className="page">
      <div className="page-head">
        ...
        {ri?.status && (ri.status.status === "NOT_AVAILABLE" || ri.status.status === "ERROR") && ri.status.message ? (
          <p className="small muted" style={{ marginTop: "var(--sp-2)" }}>RI: {ri.status.message}</p>
        ) : null}
      </div>
